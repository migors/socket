...
WORKDIR /go/src/bitbucket.org/pav5000/socketbot/
RUN go get github.com/golang/geo/s2 && \
	go get github.com/mattn/go-sqlite3 && \
	go get github.com/jmoiron/sqlx
COPY . /go/src/bitbucket.org/pav5000/socketbot/
...
WORKDIR /bot
COPY --from=builder /go/src/bitbucket.org/pav5000/socketbot/socketbot .
